...
public interface WWfMovRepository extends JpaRepository<WWfMov, Integer> {
	...
	@Query(value = "select wm.id_wf , wm.id_paso, wm.comentarios, wm.est_paso,wm.numero_radicacion,wm.id_wf_mov ,wm.nitter ,wf.nom_wf,step.nom_paso ,wm.fec_ult_mod,wm.usu_comercial from w_wf_mov wm, w_wf wf,w_wf_pasos step where "
