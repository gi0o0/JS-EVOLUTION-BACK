...
public interface W_WfRepository extends JpaRepository<W_Wf, Long> {
	...
	static String getQueryBriefcase(String scheme, String codTer) {
		String query = "select p.numero_credito, p.saldo_capital, p.estado,t.nitter as nitterPro, fo.nombre_credito, t.nomter as nomTerPro, fc.nom_claaso, ft.nom_tipaso, c.nombciud, a.nom_clase,\r\n"
				...
				+ "foclaaso fc1," + scheme
				+ "fodataso fod1 where  fc1.cod_inter = fod1.cla_asoci and fod1.cod_ter = p.codeudor1 ) as nom_claasoCod,\r\n"
				...
				+ "apo_not_credito an  where a.num_nota = an.num_nota and a.tip_comp = an.tip_comp and an.anu_nota <> 'A' and a.nro_credito = p.numero_credito)  ) as saldoK, 'Deudor' as indicador\r\n"
				...
				+ "  ( select isnull(sum(a.valor_capital_caja + a.valor_capital_nomina + a.valor_extra + a.valor_prima ),0) as valor\r\n"
				+ "	from " + scheme + "apo_not_cre_prestamo a," + scheme
				+ " apo_not_credito an  where a.num_nota = an.num_nota and a.tip_comp = an.tip_comp and an.anu_nota <> 'A' and a.nro_credito = p.numero_credito)  ) as saldoK, 'Codeudor' as indicador\r\n"
				+ " from " + scheme + "prestamo p, " + scheme + "terceros t, " + scheme + "fodataso f, " + scheme
				+ "fotipcre fo, " + scheme + "foclaaso fc," + scheme + " fotipaso ft, " + scheme + "ciudades c, "
				+ scheme + "apo_T_Cla_Aso_1 a\r\n" + " where p.codter = t.codter and p.codeudor1 <> 0\r\n"
				+ " and p.REFINANCIA = 0\r\n" + " and p.codter = f.cod_ter\r\n"
				...
				+ "foclaaso fc1, " + scheme
				+ "fodataso fod1 where  fc1.cod_inter = fod1.cla_asoci and fod1.cod_ter = p.codeudor2 ) as nom_claasoCod,\r\n"
				+ " ( select CASE Ind_est_pesona WHEN '1' THEN 'Activo /Laborando' WHEN '2' THEN 'Retirado' WHEN '3' THEN 'Fallecido' ELSE 'Sin Marcación' end from "
				+ scheme + "terceros where codter = p.codter) as est_personaDeu, \r\n"
				+ " ( select CASE Ind_est_pesona WHEN '1' THEN 'Activo /Laborando' WHEN '2' THEN 'Retirado' WHEN '3' THEN 'Fallecido' ELSE 'Sin Marcación' end from "
