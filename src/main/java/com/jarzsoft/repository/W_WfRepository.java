...
public interface W_WfRepository extends JpaRepository<W_Wf, Long> {
	...
	static String getFeesCaused(String scheme, String numcredito, String fpivote) {
		String query = "select count(1) CuoCau from " + scheme
				+ "cart_est where refinancia = 0 and numero_credito = :numcredito and fecha_pivote <= " + "CONVERT(SMALLDATETIME, '" + ":fpivote" + " 00:00:00',120)";
	...
	static String getFeesCollected(String scheme, String numcredito, String fpivote) {
		...
		//		+ " where AN.nro_CREDITO = :numcredito AND AN.num_NOTA = A.num_NOTA AND AN.tip_comp = A.tip_comp AND A.fec_NOTA <= "+ "CONVERT(SMALLDATETIME, '" + ":fpivote" + " 00:00:00',120) "
