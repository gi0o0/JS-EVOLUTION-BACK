...
public class DTOWFParameterStep {
	...
	public DTOWFParameterStep() {
		super();
	}

	public DTOWFParameterStep(Long idWf, Long idPaso, String nomPaso, String email1, String email2, String email3,
