...
public class SolCreditoMapper implements ISolCreditoMapper {
	...
	public DTOSolCredito mapperDaoToDto(DTOWF o, String codTer, String codeudor, String user, String state,String solPagare) {
		...
		out.setEntidadCartera1(o.getFinancial().getEntidad_cartera1());
		out.setObligacionCartera1(o.getFinancial().getObligacion_cartera1());
		out.setCompraNit1(o.getFinancial().getCompra_nit1());
		out.setCompraCartera2(Comunes.validIsNullNumber(o.getFinancial().getCompra_cartera2()));
		out.setEntidadCartera2(o.getFinancial().getEntidad_cartera2());
		out.setObligacionCartera2(o.getFinancial().getObligacion_cartera2());
		out.setCompraNit2(o.getFinancial().getCompra_nit2());
		out.setCompraCartera3(Comunes.validIsNullNumber(o.getFinancial().getCompra_cartera3()));
		out.setEntidadCartera3(o.getFinancial().getEntidad_cartera3());
		out.setObligacionCartera3(o.getFinancial().getObligacion_cartera3());
		out.setCompraNit3(o.getFinancial().getCompra_nit3());
		out.setCompraCartera4(Comunes.validIsNullNumber(o.getFinancial().getCompra_cartera4()));
		out.setEntidadCartera4(o.getFinancial().getEntidad_cartera4());
		out.setObligacionCartera4(o.getFinancial().getObligacion_cartera4());
		out.setCompraNit4(o.getFinancial().getCompra_nit4());
	...
	public DTOSolCredito mapperDaoToDtoFinancial(DTOWF o, DTOSolCredito credito) {
		...
		credito.setEntidadCartera1(o.getFinancial().getEntidad_cartera1());
		credito.setObligacionCartera1(o.getFinancial().getObligacion_cartera1());
		credito.setCompraNit1(o.getFinancial().getCompra_nit1());
		credito.setCompraCartera2(comunes.validIsNullNumber(o.getFinancial().getCompra_cartera2()));
		credito.setEntidadCartera2(o.getFinancial().getEntidad_cartera2());
		credito.setObligacionCartera2(o.getFinancial().getObligacion_cartera2());
		credito.setCompraNit2(o.getFinancial().getCompra_nit2());
		credito.setCompraCartera3(comunes.validIsNullNumber(o.getFinancial().getCompra_cartera3()));
		credito.setEntidadCartera3(o.getFinancial().getEntidad_cartera3());
		credito.setObligacionCartera3(o.getFinancial().getObligacion_cartera3());
		credito.setCompraNit3(o.getFinancial().getCompra_nit3());
		credito.setCompraCartera4(comunes.validIsNullNumber(o.getFinancial().getCompra_cartera4()));
		credito.setEntidadCartera4(o.getFinancial().getEntidad_cartera4());
		credito.setObligacionCartera4(o.getFinancial().getObligacion_cartera4());
		credito.setCompraNit4(o.getFinancial().getCompra_nit4());
